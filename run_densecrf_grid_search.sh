...
#######################################
		    ...
		    FEATURE_DIR=/rmt/work/deeplabel/exper/${DATASET}/features/${MODEL_NAME}/${TEST_SET}/fc8/${FILE_NAME}_numSample${NUM_SAMPLE}
		    
		    SAVE_DIR=/rmt/work/deeplabel/exper/${DATASET}/res/features/${MODEL_NAME}/${TEST_SET}/fc8/post_densecrf_W${Bi_W}_XStd${Bi_X_STD}_RStd${Bi_R_STD}_PosW${POS_W}_PosXStd${POS_X_STD}_numSample${NUM_SAMPLE}
