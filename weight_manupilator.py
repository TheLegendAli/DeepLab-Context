...
print net.params['fc8_voc12'][0].data.shape
...
print "\n\n\n\n\n\n"
ksize = 1024
y, x = np.mgrid[-ksize//2 + 1:ksize//2 + 1, -26//2 + 1:26//2 + 1]
g = np.exp(-((x**2 + y**2)/(2.0*sigma**2)))
gaussian = (g / np.sqrt(g.sum())).astype(np.float32)
print gaussian
print "\n\n\n\n\n\n"
temp_new_weight = gaussian
temp_new_weight = temp_new_weight.reshape(((26,1024,1,1)))
...
new_init.params['fc8_voc12'][1].reshape(1, 1, 1, 60)
