...
combination of few strongly labeled and many weakly labeled images in
a semi-supervised setting. (+ BBOX) We propose a modified EM algorithm
featuring a biased E-step which takes into account the weak labels
when inferring the latent training image segmentations. Extensive
experimental evaluation shows that the proposed system achieves
