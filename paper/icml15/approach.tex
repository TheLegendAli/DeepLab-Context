...
\equref{eq:scores}. The Dense CRF is then applied to infer the
...
\begin{figure}
  ...
  \begin{tabular}{c c c c}
    ...
    %% \includegraphics[width=0.21\linewidth]{fig/erode_bbox/crf/2009_000219.png} \\       
  ...
  \end{tabular}
  \caption{Estimated segmentation from bounding box annotation.% used for training.% We show three examples (easy to hard).
  }
