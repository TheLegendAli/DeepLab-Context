...
\begin{figure}[ht]
  ...
  \begin{tabular}{c c c}
    ...
    (a) & (b) & (c)
  \end{tabular}
  \caption{(a) Some comparisons with FCN-8S: (left) image (middle) FCN-8S (right) ms-crf. (b) Segmentation accuracy (pixelwise accuracy) within trimap. (c) Segmentation accuracy (mean IOU) within trimap. {\color{red} TODO: change legend. HELP: I cannot make them equally spaced....}}
