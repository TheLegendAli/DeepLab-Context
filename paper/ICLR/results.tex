...
%a DCNN is first fine-tuned on the training set and then, as in the work of \citet{krahenbuhl2011efficient}  we cross-validate the 
 ...
 to avoid overfitting the validation set, the parameters $w_2$ and $\sigma_\gamma$ are fixed to be $3$ and the best values of $w_1$, $\sigma_\alpha$, and $\sigma_\beta$ are cross-validated on a small subset of the validation set (we use around 200 images).  
