...
\centering
  \begin{tabular} {c c c}
    ...
    \end{tabular} &
    \includegraphics[height=0.2\linewidth]{fig/SegPixelAccWithinTrimap.pdf} &
    \includegraphics[height=0.2\linewidth]{fig/SegPixelIOUWithinTrimap.pdf} \\
   \end{tabular}
  \caption{Quality of segmentation result within a band around the object
    ...
    Pixel mean IOU. {\color{red} I cannot make it right.....(jay)}
    }  
  \label{fig:IOUBoundary}
\end{table}
