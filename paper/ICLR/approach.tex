...
%% We consider this receptive field size to be too
...
%% subsampling the first FC layer to \by{4}{4} spatial size. 

We have addressed this practical problem by spatially subsampling (by
simple decimation) the first FC layer to \by{4}{4} spatial size. This
