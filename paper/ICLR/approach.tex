...
\subsection{Shrinking the Receptive Field of Neural Networks}
...
% Initialize $b_i(x_i) \leftarrow \frac{1}{Z_i} \exp \Big(-\theta_i(x_i) \Big)$
...
% \item $\hat{b_i}(x_i) \leftarrow \sum_{l} \sum_m w^m \cdot \tilde{b_i}^m(l)$
