...
\begin{figure}[ht]
  ...
  \end{tabular}
  \caption{The CNNn score map, CNN belief map (normalize the score), and CRF belief maps (at iteration 1, 2, and 10) for Background (first row) and Aeroplane (second row).
    }
