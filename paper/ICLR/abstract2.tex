...
In particular, we first demonstrate that simple modifications to the standard architectures used for object classification can deliver impessively accurate semantic segmentation results while operating at XXX frames-per-seconds. We then couple DCNNs  with Mean Field inference for Markov Random Fields  and obtain state-of-the-art results on the PASCAL semantic image segmentation task.  
